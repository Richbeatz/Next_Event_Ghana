...
Fpdf::Cell(100, 10, ':  Short Term Loan ('.$get_request_info->loan_type.')', 0, 1, 'L');
...
Fpdf::Cell(100, 10, ':  '. $get_request_info->interest_rate .'% per annum on reducing balance method (Fixed Instalment). Interest ', 0, 1, 'L');
Fpdf::Cell(50, 5, '', 0, 0, 'L');
Fpdf::Cell(100, 5, ' shall continue to apply until the facility is fully repaid.', 0, 1, 'L');
...
Fpdf::Cell(50, 10, 'Penal Interest Rate', 0, 0, 'L');
Fpdf::Cell(100, 10, ':  Any Principal Installment which is not funded on due date shall attract a penal', 0, 1, 'L');
Fpdf::Cell(50, 5, '', 0, 0, 'L');
Fpdf::Cell(100, 5, '    rate of 6 % per annum.', 0, 1, 'L');
...
Fpdf::SetFont('Arial', 'B', 12);
Fpdf::Cell(50, 10, 'Secondary Source', 0, 0, 'L');
Fpdf::SetFont('Arial', '', 12);
Fpdf::Cell(100, 10, ':  Provident Fund.', 0, 1, 'L');
//Fpdf::Cell(100, 5, '', 0, 1, 'L');
...
Fpdf::SetFont('Arial', '', 12);
Fpdf::Cell(0, 10, '		*    Duly accepted offer letter signed by the authorized signatories to the account of the borrower.', 0, 2,'L');
Fpdf::Cell(0, 10, '		*    Upfront payment of facility fees.', 0, 2,'L');
Fpdf::Cell(0, 10, '		*    Duly signed third party gurantee before disbursement.', 0, 2,'L');
Fpdf::Cell(0, 10, '		*    Duly signed benefit claim form.', 0, 2,'L');
...
Fpdf::Cell(0, 10, 'Security:', 0, 2,'L');
Fpdf::SetFont('Arial', '', 12);
Fpdf::Cell(0, 10, '		Provident fund with Best Point.', 0, 1,'L');
// }else{
...
//Fpdf::Image($supervisor_img != '' ? $supervisor_img : asset('storage/app/signature/empty.jpg'), 110, 225, 40);
